    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Thêm Khuyến mãi mới</h4>
            </div>
        </div>
    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('discount_type') is-invalid @enderror" 
                                            ...
                                            <option value="buy_x_get_y" {{ old('discount_type') == 'buy_x_get_y' ? 'selected' : '' }}>
                                                Mua X tặng Y
                                            </option>
                                        </select>
                                        @error('discount_type')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('maximum_discount_amount') is-invalid @enderror" 
                                               ...
                                               value="{{ old('maximum_discount_amount') }}" step="0.01" min="0" 
                                               placeholder="0 (không giới hạn)">
...
$(document).ready(function() {
    ...
    $('#discount_type').change(function() {
        ...
        switch(type) {
            case 'percentage':
                ...
                placeholder = 'Ví dụ: 20 (tức 20%)';
                break;
            case 'fixed_amount':
                hint = 'Nhập số tiền giảm cố định (VNĐ)';
                placeholder = 'Ví dụ: 100000 (tức 100.000đ)';
                break;
            case 'buy_x_get_y':
                hint = 'Nhập số lượng sản phẩm cần mua để được tặng 1';
                placeholder = 'Ví dụ: 2 (mua 2 tặng 1)';
                break;
        }
        
        $('#discount_hint').text(hint);
        $('#discount_value').attr('placeholder', placeholder);
    });
    ...
    if (!$('#start_date').val()) {
        $('#start_date').val(formatDateTime(tomorrow));
    }
    if (!$('#end_date').val()) {
        $('#end_date').val(formatDateTime(nextWeek));
    }
